 ...
 */
public class VacancyListPageActivity extends ActionBarActivity {
    ...
    public VacancyListPageActivity(String url) {
        this.vacancyJsonUrl = url;
    }

    @Override
    public void onCreate(Bundle savedInstanceState) {
       setContentView(R.layout.fragment_vacancy_list);
        expListView = (ExpandableListView) findViewById(R.id.vacancy_exp_list);
        ...
        pageParseTask.execute(url);
    }

    public static VacancyListPageActivity newInstance(String url) {
        return new VacancyListPageActivity(url);
    }
